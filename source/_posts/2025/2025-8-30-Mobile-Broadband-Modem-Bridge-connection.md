---
title: 家庭网络升级：光猫改桥接 + 路由器拨号（含 IPv6 PD 验证）
...
![光猫背面标签](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301536870.jpg)
...
- 点击“启用或关闭Windows功能”
  ![Windows功能窗口](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301650916.png)

- 勾选“Telnet客户端”后确定
  ![启用Telnet客户端](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301651234.png)

### 通过Telnet连接并获取配置文件

- 按`Win + R`打开运行窗口，输入`cmd`启动命令行  
  ![命令行界面](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301656807.png)
...
- 输入管理员账号：`CMCCAdmin`
  ...
  ![输入管理员账号](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301700833.png)
...
- 输入管理员密码：`aDm8H%MdA`
  ...
  ![输入管理员密码](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301711829.png)
...
- 登录成功后输入`ls`命令，验证系统权限
  ...
  ![权限验证](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301712946.png)
...
- 显示超级管理员账号及密码
  ![超级管理员凭证](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301720728.png)
...
- 进入“网络设置”界面
  ![网络设置入口](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301725319.png)
...
- 准确找到`PPPoE账号密码`字段
  ![PPPoE账号密码明文](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301801036.png)
...
- 将“连接模式”修改为`桥接模式`，保存设置
  ![修改为桥接模式](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301806834.png)

## 配置路由器拨号

- 登录路由器管理界面
- 于网络设置中选择`PPPoE拨号`方式
  ![PPPoE拨号选项](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301810270.png)

- 输入此前获取的宽带账号与密码，完成配置
  ![填写拨号信息](https://cdn.jsdmirror.com/gh/MingTechPro/drawing-bed/post-img_url/202508301814066.png)
